...
GUID = '8dadc2c9-8af5-447c-a86c-9852a4df8585'
...
CmdletsToExport = 'Get-EducationClass', 'Get-EducationClassAssignment', 
               ...
               'Get-EducationClassDelta', 'Get-EducationClassGroup', 
               'Get-EducationClassMember', 'Get-EducationClassMemberDelta', 
               'Get-EducationClassSchool', 'Get-EducationClassSchoolDelta', 
               'Get-EducationClassTeacher', 'Get-EducationClassTeacherDelta', 
               ...
               'Get-EducationMeClass', 'Get-EducationMeClassDelta', 
               'Get-EducationMeRubric', 'Get-EducationMeSchool', 
               'Get-EducationMeSchoolDelta', 'Get-EducationMeTaughtClass', 
               'Get-EducationMeTaughtClassDelta', 'Get-EducationMeUser', 
               'Get-EducationRoot', 'Get-EducationSchool', 
               'Get-EducationSchoolAdministrativeUnit', 'Get-EducationSchoolClass', 
               'Get-EducationSchoolClassDelta', 'Get-EducationSchoolDelta', 
               'Get-EducationSchoolUser', 'Get-EducationSchoolUserDelta', 
               ...
               'Get-EducationUserClass', 'Get-EducationUserClassDelta', 
               'Get-EducationUserDelta', 'Get-EducationUserRubric', 
               'Get-EducationUserSchool', 'Get-EducationUserSchoolDelta', 
               'Get-EducationUserTaughtClass', 'Get-EducationUserTaughtClassDelta', 
