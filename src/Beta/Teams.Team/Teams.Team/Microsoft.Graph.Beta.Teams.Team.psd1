...
GUID = '675168f3-4a41-4ab3-9137-4a2a71a21ab8'
...
CmdletsToExport = 'Copy-Team', 'Get-GroupTeam', 'Get-Team', 'Get-TeamApp', 
               ...
               'Get-TeamChannelMessageDelta', 
               'Get-TeamChannelMessageHostedContent', 
               'Get-TeamChannelMessageReply', 'Get-TeamChannelMessageReplyDelta', 
               'Get-TeamChannelTab', 'Get-TeamChannelTabTeamApp', 'Get-TeamGroup', 
               'Get-TeamInstalledApp', 'Get-TeamInstalledAppTeamApp', 
               ...
               'Get-TeamPrimaryChannelMessageDelta', 
               'Get-TeamPrimaryChannelMessageHostedContent', 
               'Get-TeamPrimaryChannelMessageReply', 
               'Get-TeamPrimaryChannelMessageReplyDelta', 
               'Get-TeamPrimaryChannelTab', 'Get-TeamPrimaryChannelTabTeamApp', 
               'Get-TeamSchedule', 'Get-TeamScheduleOpenShift', 
               ...
               'Invoke-MessageTeam', 'Invoke-ShareTeamSchedule', 
               'Invoke-UnarchiveTeam', 'New-Team', 'New-TeamApp', 'New-TeamChannel', 
               'New-TeamChannelChatThread', 'New-TeamChannelMember', 
               'New-TeamChannelMessage', 'New-TeamChannelMessageHostedContent', 
